        ...
        <div className="reveal">
          <div className="plate">
            ...
            <p>
              ...
              social media content and ads that hold attention, including AI video
              and AI photo.
            </p>
            <p style={{ marginBottom: 0 }}>
              Across three companies I've owned edits end to end — from
              storyboarding and rough cuts to color and final delivery. This site
      ...
      <div className="container about-detail">
        ...
        <div className="reveal">
          <div className="plate">
            ...
            <p style={{ marginBottom: 0 }}>
              I am proficient in using Adobe software to edit photos and videos for
              promoting content on the company's social media platforms.
              Additionally, I am able to use CapCut for quick video edits and Canva
              for creating promotional posters.
            </p>
          </div>
        </div>
      </div>
